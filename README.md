<h1>Spring Data JPA na prática com Java usando PostgreSQL </h1>
<p>Elaboração do projeto <strong>Academia de Ginástica.</strong>

<h2>🎯 Objetivo do Projeto</h2>
<p>Aprimoramento dos principais conceitos de mapeamento objeto relacional (ORM) usando o <strong>Spring Data JPA</strong>. Para isso, uma <strong>API RESTful</strong> será desenvolvida com ênfase na modelagem de suas entidades, no domínio de uma academia de ginástica.</p>
...
<ul>
    <li>IDE IntelliJ IDEA 2022.2 (Community Edition)</li>
    <li>Java 11</li>
    <li>Maven</li>
...
Disponibilizado por [Eduardo Martim](https://www.linkedin.com/in/eduardomartim/)